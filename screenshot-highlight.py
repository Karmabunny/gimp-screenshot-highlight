...
def plugin_main(image, drawable, ): # <= formal parameters
  ...
  pdb.gimp_selection_feather( ephemera.top(PF_IMAGE), 10.0, )
  ephemera.update()
  
  # Select/Invert
  pdb.gimp_selection_invert( ephemera.top(PF_IMAGE), )
  ephemera.update()
  
  # Brightness/Contrast
  pdb.gimp_brightness_contrast( ephemera.top(PF_DRAWABLE), -90, 0 )
 # <= body
  #
 # <= postlude
